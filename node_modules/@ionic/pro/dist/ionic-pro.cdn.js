...
var Deploy = /** @class */ (function () {
     ...
     */
    Deploy.prototype.init = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.app.getPlugin()];
                    case 1:
                        plugin = _a.sent();
                        if (typeof config.appId === 'undefined') {
                            config.appId = this.app.appId;
                        }
                        return [2 /*return*/, plugin.deploy.configure(config)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, plugin.deploy.getCurrentVersion()];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [4 /*yield*/, plugin.deploy.checkForUpdate()];
                    case 2: return [2 /*return*/, (_a.sent()).available];
                }
            });
        });
    };
     ...
     */
    Deploy.prototype.download = function (progress) {
        return __awaiter(this, void 0, void 0, function () {
            var plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, plugin.deploy.downloadUpdate(progress)];
                }
            });
        });
    };
     ...
     * @return {Promise} resolves when completed
     */
    Deploy.prototype.extract = function (progress) {
        return __awaiter(this, void 0, void 0, function () {
            var plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, plugin.deploy.extractUpdate(progress)];
                }
            });
        });
    };
     ...
     * @return {Promise} resolves when completed
     */
    Deploy.prototype.redirect = function () {
        return __awaiter(this, void 0, void 0, function () {
            var plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, plugin.deploy.reloadApp()];
                }
            });
        });
    };
     ...
     */
    Deploy.prototype.checkAndApply = function (redirect, progress) {
        if (redirect === void 0) { redirect = false; }
        return __awaiter(this, void 0, void 0, function () {
            var hasUpdate, downloaded;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.check()];
                    case 1:
                        hasUpdate = _a.sent();
                        if (!hasUpdate) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.download(progress)];
                    case 2:
                        downloaded = _a.sent();
                        if (!redirect) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.redirect()];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [2 /*return*/, { 'update': true, 'redirected': redirect }];
                    case 5: return [2 /*return*/, { 'update': false, 'redirected': false }];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, plugin.deploy.getAvailableVersions()];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, plugin.deploy.deleteVersionById(uuid)];
                }
            });
        });
    };
     ...
     */
    Deploy.prototype.configure = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    Deploy.prototype.checkForUpdate = function () {
        return __awaiter(this, void 0, void 0, function () {
            var plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, plugin.deploy.checkForUpdate()];
                }
            });
        });
    };
     ...
     */
    Deploy.prototype.deleteVersionById = function (versionId) {
        return __awaiter(this, void 0, void 0, function () {
            var plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, plugin.deploy.deleteVersionById(versionId)];
                }
            });
        });
    };
     ...
     */
    Deploy.prototype.downloadUpdate = function (progress) {
        return __awaiter(this, void 0, void 0, function () {
            var plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    Deploy.prototype.extractUpdate = function (progress) {
        return __awaiter(this, void 0, void 0, function () {
            var plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    Deploy.prototype.getAvailableVersions = function () {
        return __awaiter(this, void 0, void 0, function () {
            var plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    Deploy.prototype.getCurrentVersion = function () {
        return __awaiter(this, void 0, void 0, function () {
            var plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    Deploy.prototype.reloadApp = function () {
        return __awaiter(this, void 0, void 0, function () {
            var plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    Deploy.prototype.sync = function (syncOptions) {
        return __awaiter(this, void 0, void 0, function () {
            var plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        plugin = _a.sent();
                        return [2 /*return*/, plugin.deploy.sync(syncOptions)];
                }
            });
        });
    };
